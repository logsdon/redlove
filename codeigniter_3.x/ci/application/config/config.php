...
|
*/
$config['encryption_key'] = 'glUklaCHiE5ria8P7abRouD7oUmOecrL';
...
|
*/
$config['sess_driver'] = 'database';// Default 'files'
$config['sess_cookie_name'] = 'ci_session';
$config['sess_expiration'] = (60 * 60 * 24 * 7) + (60 * 60 * 26);// 1 week// Allow for 26 hour server vs browser timezone difference (+ (60 * 60 * 26))// Default 7200
$config['sess_save_path'] = 'ci_session';// Default NULL
$config['sess_match_ip'] = FALSE;
$config['sess_time_to_update'] = (60 * 60 * 4);// 4 hours// Default 300
